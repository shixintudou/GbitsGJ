...
public class ColorInvertRenderPass : ScriptableRenderPass
{
    private ColorInvertRendererFeature.ColorInvertSettings settings;
    private RenderTexture ColorInvertRT;
    private ComputeShader computeShader;
    public static int originID;
    public static int targetID;
    public ColorInvertRenderPass(ColorInvertRendererFeature.ColorInvertSettings settings)
    {
